...
export default function SummarizerPage() {
  ...
  if (loading || !user) {
    return (
      <div className={`min-h-screen flex items-center justify-center ${isTransformersTheme ? 'transformers-bg-summarizer' : ''}`}>
  ...
  return (
    <div className={`min-h-screen ${isTransformersTheme ? 'transformers-bg-summarizer' : ''}`}>
